...
'''Set of tranform random routines that takes list of inputs as arguments, in order to have random but coherent transformations.'''
    ...
    def __call__(self, images, intrinsics):
        ...
        for im in images :  # CHW
            ...
            for x in range(0,self.bins) :
                ...
                # mul1 = subhist * (subhist_new_itv / itv)
                # sub1 = subhist * (subhist_new_itv / itv * -(imgs_min+itv*x) + subhist_new_min)
                # mul_mask_[x, ...] = mul1[0]
                # sub_mask_[x, ...] = sub1[0]
