#!/bin/bash
# run script : bash test_indoor.sh

GPU_ID=0
DATA_ROOT=/home/MSDFNetl/Dataset_processed/VIVID_320/
RESULTS_DIR=results/
...
NAMES=("MSDFNet_indoor/MM-dd-HH:mm")
...
for NAME in ${NAMES[@]}; do
	...
	POSE_NET=/home/guazhi/code/Thermal/checkpoints/${NAME}/dispnet_disp_model_best.pth.tar
	DISP_NET=/home/guazhi/code/Thermal/checkpoints/${NAME}/exp_pose_disp_model_best.pth.tar
	echo "${NAME}"
