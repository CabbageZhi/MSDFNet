#!/bin/bash
# run script : bash test_outdoor.sh

GPU_ID=0
DATA_ROOT=/home/MSDFNet/Dataset_processed/VIVID_320/
RESULTS_DIR=results/
...
# outdoor testset
NAMES=("MSDFNet_outdoor/MM-dd-HH:mm")

for NAME in ${NAMES[@]}; do
	SEQS=("outdoor_robust_night1" "outdoor_robust_night2" )
	POSE_NET=/home/guazhi/code/Thermal/checkpoints/${NAME}/exp_pose_disp_model_best.pth.tar
	DISP_NET=/home/guazhi/code/Thermal/checkpoints/${NAME}/dispnet_disp_model_best.pth.tar
	echo "${NAME}"
